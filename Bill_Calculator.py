...
class JsonFunctions:
    ...
    def json_exists(self):
        ...
        if file_exists:
            ...
            test_dict = {
                'Years': ['2022-01', '2022-01', '2022-02', '2022-03', '2022-04', '2022-04', '2022-05', '2022-06',
                          '2022-07', '2022-08', '2022-09', '2022-10',
                          '2022-11', '2022-12', '2023-01', '2023-01', '2023-02', '2023-03'],
                ...
                'Electricity': [3000, 1777, 2000, 1500, 1100, 800, 501, 700, 600, 800, 900, 1000, 1100, 3060, 300, 500,
                                600, 900],
                'Gas': [4000, 2100, 800, 401, 401, 450, 301, 401, 400, 403, 450, 477, 402, 400, 490, 403, 440, 407]
            }
